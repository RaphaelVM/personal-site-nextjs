            ...
            <main className='font-mono text-white'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 place-items-center gap-x-4'>
                        ...
                        <div className="col-span-1 mt-5 md:mt-0">
                            <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
                                <div className="col-span-1 flex justify-center p-4 z-1 rounded transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-600 duration-300">
                                    <Image
                                        src={htmlLogo}
                                        alt="HTML Logo"
                                    />
                ...
                <section className='bg-stone-800 shadow-xl p-20 lg:px-40' id='waar'>
                    <div className='grid place-items-center'>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 mt-5 md:mt-10 gap-y-10 sm:gap-y-10 sm:gap-x-10'>
                            <div className='col-span-1'>
